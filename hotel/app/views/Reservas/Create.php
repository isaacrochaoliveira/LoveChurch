<div class="template-container">
    <h1 class="fs-22pt colors-dark-blue text-decoration-underline">Nova Reserva</h1>
    <form action="<?= URL_BASE ?>reservas/create ?>" method="post">
        <div class="row">
    ...
    <hr>
    <form action="<?= URL_BASE ?>reservas/salvar" method="post">
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-1">
                ...
                <select name="quarto" id="quarto" class="form-select">
                    <?php
                    foreach ($quartos as $availables) {
                    ?>
                        <option value="<?= $availables->id_quartos ?>"><?= $availables->numero ?></option>
                    <?php
                    }
                    ?>
                </select>
