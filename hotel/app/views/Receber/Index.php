<div class="template-container">
    <form action="<?= URL_BASE ?>receber/billsfilter" method="post" class="padding-0">
        <div class="row">
            <div style="width: 40px" class="col-md-1 my-auto text-left">
                <div class="dropdown hover" id="submenu__option_receber">
                    ...
                    <div class="dropdown-menu">
                        <li>
                            <a href="<?= URL_BASE ?>receber/semreservas" class="btn-nova__contasemreservaconta dropdown-item">
                                <span class="material-symbols-sharp">
                                    domain_disabled
                                </span>
            ...
            <div class="col-md-4">
                <div class="form-floating">
                    ...
                    <label for="nome">Pesquisar Pelo Quarto</label>
                </div>
            </div>
            <div class="col-md-3">
        ...
        <button type="submit" id="submit--receber__filter" style="display: none;"></button>
    </form>
    <?php
    $this->verMsg();
    $this->verErro();
...
<div class="template-container">
    <div class="d-flex flex-wrap justify-content-between">
        ...
        <div>
            <a href="<?= URL_BASE ?>receber/index" class="btn__reset--billsfilter">
                <span class="material-symbols-sharp">
                    restart_alt
                </span>
                RESET
        ...
        ?>
            <div class="col-md-6">
                <div class="row square__receber">
                    <div class="col-md-8">
                        <div class="">
                            <p class="data__lanc_venc">Check-In: <?= Date('d/m/y', strtotime($receber[$key]->check_in)) ?></p>
                            ...
                            <a href="<?= URL_BASE ?>receber/details/<?= $receber[$key]->id ?>">
...
<script src="<?= URL_BASE ?>assets/js/js__receber.js"></script>