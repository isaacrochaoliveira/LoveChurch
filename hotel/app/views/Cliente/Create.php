				...
				<div class="base-form">
					<div class="caixa-form">
						<div class="thead">Inserir novo cadastro</div>
						 ...
						 <!-- Não esquece do metodo e da ação  --> 	
						<form action="<?php echo URL_BASE ."cliente/salvar"?>" method="POST">
						<?php 
						      $this->verMsg(); //ver as mesagem 
						      $this->verErro();//ver os erroas
						?>					
							<div class="rows">
							  <div class="col-3 position-relative">	
								...
								<div class="rows">
									<div class="col-12">
										...
										<!-- Este segundo nome ($cliente->cliente) e o nome que esta no banco de dados  -->       
