					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="dataTable">
						...
						<tbody>
                            ...
                            <tr>
                            	...
                            	<td align="center"><a href="<?php echo URL_BASE ."cliente/edit/". $cliente->id_cliente ?>" class="btn btn-verde d-inline-block">Editar</a></td>
								
                            	<td align="center"><a href="javascript:;" onclick="excluir(this)" data-entidade="cliente" data-id="<?php echo $cliente->id_cliente ?>" class="btn btn-vermelho d-inline-block">Excluir</a></td>
                            </tr>	
                            <?php } ?>
